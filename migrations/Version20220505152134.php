 ...
 */
final class Version20220505152134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pfe (id INT AUTO_INCREMENT NOT NULL, pfe_collection_id INT DEFAULT NULL, titre VARCHAR(20) NOT NULL, nom_etudiant VARCHAR(20) NOT NULL, INDEX IDX_A5CFE8B499904FD1 (pfe_collection_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
